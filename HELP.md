...
Use CMD to install local tunnel (PS. If localtunnel doesn't work for your use case for whatever reason, alternatives like https://ngrok.io)
===============================
localtunnel links can be sused for very short time. so keep refreshing each 5-10 mins

             npm install -g localtunnel 
			 
			C:\Users\vashi>lt --version
			2.0.2

			C:\Users\vashi>lt --port 8080
			your url is: https://giant-kings-build.loca.lt
			 
			 
			 lt --port 9090
			 
             locultunnel - https://small-lions-create.loca.lt
            ...
            1) Use webhooks for payment using following links ( first create a tunnellink and register with webhooks)
			    https://dashboard.stripe.com/test/workbench/overview
				
				https://docs.stripe.com/testing for testing fake credit cards